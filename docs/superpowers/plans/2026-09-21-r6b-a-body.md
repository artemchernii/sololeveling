...
**This task carries a spec rule into `PLAN.md`. Do not skip step 6.** §1 defines source 2 as _the latest_ snapshot; this reads the same source as a series, and the licence is only valid written down.
