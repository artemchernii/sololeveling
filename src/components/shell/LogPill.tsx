...
/* PLAN.md §3, mobile: a sticky "+ Log" pill, above the bottom nav and inside
   the thumb's reach.

   It opens the same modal as the desktop button — capture has one
   ...
   already visible. */
export function LogPill({ onLog }: { onLog: () => void }) {
  return (
    <button
      type="button"
      onClick={onLog}
